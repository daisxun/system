...
/**
 * Given a .map function, builds a .map function which throws an error if any mapped elements do not pass a truthyness test.json.
 * @example
 * ```
 *
 ...
 * @hidden
 *
 * @param state a State Object to test.json against
 * @param criterion
...
var StateService = (function () {
     ...
     * to test.json against the current active state.
     * @param options An options object. The options are:
     *   - `relative`: If `stateOrName` is a relative state name and `options.relative` is set, .is will
     *     test.json relative to `options.relative` state (or name).
     *
     ...
     * Not all the parameters need to be passed, just the ones you'd like to test.json for equality.
     *
     ...
     *   that you'd like to test.json against the current active state.
     * @param options An options object. The options are:
     *   - `relative`: If `stateOrName` is a relative state name and `options.relative` is set, .is will
     *     test.json relative to `options.relative` state (or name).
     *
...
var StateProvider = (function () {
     ...
     *   would pass a `$state.includes()` test.json.
     *
     * #### Example:
